...
export function VoiceButton({
  ...
  // Quando o áudio estiver pronto, chama o callback e reseta o estado
  useEffect(() => {
    if (audioBlob && recordingState === "processing") {
      onAudioRecorded(audioBlob);
      // Reseta o estado após chamar o callback
      resetRecording();
    }
  }, [audioBlob, recordingState, onAudioRecorded, resetRecording]);
